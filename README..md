...
This tool analyzes job postings and gives:
	...
	•	A list of reasons behind the result
...
│
├── utils/
│   ├── verifier.py            → Adzuna, email check, keyword scan
...
The system displays:
	...
	•	Full explanation of risk factors
...
This project is built to:
	...
	•	Serve as a professional project for academic and portfolio use
